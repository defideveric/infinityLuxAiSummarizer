...
const Demo = () => {
  ...
  //for storing article history in local storage
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(data?.summary) {
      ...
      //array for pushing new articles to
  ...
  return (
    ...
    {/* Search Bar */}
      <div className='flex flex-col w-full gap-2'>
        ...
        {/* Browse URL History */}
        <div className='flex flex-col gap-8 max-h-60 overflow-y-auto'>
